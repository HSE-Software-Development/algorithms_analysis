 ...
 */
 ...
 #include <algo_analysis/algorithms/floid.hpp>
...
TEST(Floid, Task01) {
    ...
    FloidAlgorithm<int> floid;
    auto results = task.run(floid);
...
TEST(Floid, TaskSeveralComponents) {
    Task<int> task(
...
TEST(Floid, TaskCycleWithExtraEdges) {
    Task<int> task(
